...
public enum ErrorCode {
    ...
    HTTP_STATUS_501(HttpStatus.BAD_GATEWAY, "9001", "대외계 연동 구간 처리 중 오류가 발생 했습니다."),
    // 503 SERVICE UNAVAILABLE (대외계 처리 중 내부 오류 발생.[대외계 서버 작업 또는 프로세스 오류] )
    HTTP_STATUS_503(HttpStatus.SERVICE_UNAVAILABLE, "9002", "대왜계 서버 작업 영향으로 서비스 이용이 원활 하지 않습니다."),
    // 504 GATEWAY TIMEOUT [connection timeout/refused, read timeout, write timeout]
    HTTP_STATUS_504(HttpStatus.GATEWAY_TIMEOUT, "9003", "대외계 통신 연결이 원뢀 하지 않습니다. 잠시 후 다시 시도 바랍니다.");
